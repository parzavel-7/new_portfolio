...
const Navbar = ({ isDarkMode, setIsDarkMode }) => {
  ...
  return (
    <>
      ...
      <nav
        className={`w-full fixed px-5 lg:px-8 xl:px-[8%] py-3 flex justify-between z-50 ${
          isScroll
      ...
      >
        ...
        <ul
          ref={sideMenuRef}
          className="md:hidden flex flex-col items-center rounded-xl border border-gray gap-4 px-12 py-21 fixed -right-63 top-0 bottom-0 w-64 z-50 h-screen bg-gray-400 transition duration-700 dark:bg-darkHover dark:text-white"
        >
          ...
          <li>
            <a
              href="#services"
              className="font-Ovo p-5 px-12 rounded-full hover:bg-gray-500 transition duration-700"
              onClick={closeMenu}
            >
              Services
            </a>
          ...
          <li>
            <a
              href="#contact"
              className="font-Ovo p-5 px-11 rounded-full hover:bg-gray-500 transition duration-700"
              onClick={closeMenu}
            >
              Contact me
            </a>
