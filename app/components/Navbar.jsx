  ...
  return (
    <>
      ...
      >
        ...
        <ul
          ref={sideMenuRef}
          className="md:hidden flex flex-col items-center gap-4 px-10 py-20 fixed -right-64 top-0 bottom-0 w-64 z-50 h-screen bg-gray-400 transition duration-500 dark:bg-darkHover dark:text-white"
        >
